...
' Control Center G2 to check what errors are occurring.

Imports Pololu.UsbWrapper
Imports Pololu.SimpleMotorControllerG2
Imports System
Imports System.Text
...
Public Class MainWindow
    ...
    ''' <summary>
    ''' Connects to a Simple Motor Controller G2 using native USB and returns the
